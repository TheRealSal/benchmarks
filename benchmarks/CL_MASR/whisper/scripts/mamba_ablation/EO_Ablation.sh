...
EOF
  ...
  # --- EO_S4A ---
  tee "$LOGDIR/EO_idx${IDX}_d${D_STATE}_e${EXPAND}_k${KERNEL_SIZE}.log" < <(
    python train_ft_adapters.py hparams/mamba_ablation/EO_S4A.yaml \
