#!/bin/bash
#SBATCH --job-name=CKB_Bn_decoder
#SBATCH --time=4:30:0
#SBATCH --ntasks=2
...
EOF
    ...
    python train_ft_adapters.py hparams/CKB/decoder/CKB_Bn.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed $seed --projection_size $rank --location "decoder"
done