...
EOF
    ...
    python train_ft_adapters.py hparams/CKB/enc_dec/CKB_S4A_Alpha.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --seed $seed --projection_size $rank --location "enc_dec"
done