#!/bin/bash
#SBATCH --job-name=CKB_S4A_enc_dec
#SBATCH --time=2:0:0
#SBATCH --ntasks=2
...
EOF
    ...
    python train_ft_adapters.py hparams/CKB/enc_dec/CKB_S4A_Alpha.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed $seed --projection_size $rank --location "enc_dec"
done