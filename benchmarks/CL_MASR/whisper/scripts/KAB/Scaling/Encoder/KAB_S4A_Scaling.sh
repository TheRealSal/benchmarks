...
python train_ft_adapters.py hparams/KAB/Encoder/KAB_S4A.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed 0 --projection_size $rank --location "encoder"