#!/bin/bash
#SBATCH --job-name=KAB_S4A_proj_sweep
#SBATCH --array=0-10
#SBATCH --time=2:30:00
#SBATCH --ntasks=2
...
python train_ft_adapters.py hparams/KAB/Decoder/KAB_S4A.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed 0 --projection_size $rank --location "decoder"