#!/bin/bash
#SBATCH --job-name=KAB_Con_proj_sweep
#SBATCH --array=0-10
#SBATCH --time=1:0:00
#SBATCH --ntasks=2
...
#SBATCH --nodes=1
#SBATCH --output=logs/AB/Scaling_Con/array_%A_%a.out
...
projection_sizes=(512 384 256 128 112 104 96 80 72 64 48 36 32 24 16)
rank=${projection_sizes[$SLURM_ARRAY_TASK_ID]}

python train_ft_adapters.py hparams/KAB/enc_dec/KAB_Con.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed 0 --projection_size $rank --location "enc_dec"