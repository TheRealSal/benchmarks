...
EOF
    ...
    python train_ft_adapters.py hparams/KAB/enc_dec/KAB_LoRA.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --seed $seed --projection_size $rank --location "enc_dec"
done