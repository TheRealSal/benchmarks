...
EOF
    ...
    python train_ft_adapters.py hparams/EO/decoder/EO_Bn.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed $seed --projection_size $rank --location "decoder"
done