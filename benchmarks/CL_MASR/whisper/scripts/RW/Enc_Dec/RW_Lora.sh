#!/bin/bash
#SBATCH --job-name=RW_Lora_enc_dec
#SBATCH --time=2:20:0
#SBATCH --ntasks=2
...
EOF
    ...
    python train_ft_adapters.py hparams/RW/enc_dec/RW_LoRA.yaml --data_folder $SLURM_TMPDIR/CL_MASR/CL-MASR --scratch_folder $SCRATCH/whisper --seed $seed --projection_size $rank --location "enc_dec"
done